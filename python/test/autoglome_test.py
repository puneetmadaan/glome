...
class AutoGlomeTestVector:
    ...
    def __init__(self, test_vector, truncated_tag_length, skippable_range):
        ...
        self.sender_glome = pyglome.AutoGlome(peer_key, my_key,
                                              truncated_tag_length,
                                              skippable_range)
        ...
        self.receiver_glome = pyglome.AutoGlome(peer_key, my_key,
                                                truncated_tag_length,
                                                skippable_range)
...
class AutoGlomeTestBase:
    ...
    def test_check_counters_are_correctly_setted(self):
        test_vector = self.test_vector
        test_vector.sender_glome.sending_counter = 0
    ...
    def test_skippable_range(self):
        test_vector = self.test_vector
        try:
            test_vector.receiver_glome.receiving_counter = test_vector.data.counter
